...
| [issue-intake](./plugins/issue-intake/) | As-Is / To-Be 形式の要望から重複チェック付きで Issue を起票 | 「Issue を作って」「As-Is To-Be で起票」「これチケットにして」 |
| [github-issue-pr-flow](./plugins/github-issue-pr-flow/) | 既存の Issue を Branch → 実装 → PR の順で消化するワークフロー | 「#42 やって」「次の P1 やって」「○○を直して」 |
